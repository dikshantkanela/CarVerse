...
const Undertwenty = () => {
  const data = indianCars.filter((car)=>{
    return car.topModelPrice<=20
})
  return (
    <div>
       <h2 className="text-6xl mt-[100px] font-semibold my-5 text-center  text-blue-900">Cars Under 20 Lakhs</h2>
